...
http.createServer((req, res) => {
  ...
  var mime = "text/html"  // Si el tipo mime lo escribimos mal, el navegador genera un fichero para que
                          // que lo descarguemos
  res.writeHead(200, {'Content-Type': mime}); // Lo mínimo que hay que enviar es el tipo de contenido
                                              // (lo dice el estándar)
